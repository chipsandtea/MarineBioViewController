...
class GroupNameViewController: ResponsiveTextFieldViewController,UIPickerViewDelegate {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        var DestVC: MarineBioViewController = segue.destinationViewController as MarineBioViewController
